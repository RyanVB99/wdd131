...
allTempleButton.addEventListener('click', function (event) {
    event.preventDefault();
    document.querySelector('#temples').innerHTML = templeCards.join('');
});

oldTempleButton.addEventListener('click', function (event) {
    event.preventDefault();
    document.querySelector('#temples').innerHTML = oldTempleCards.join('');
});

newTempleButton.addEventListener('click', function (event) {
    event.preventDefault();
    document.querySelector('#temples').innerHTML = newTempleCards.join('');
});

largeTempleButton.addEventListener('click', function (event) {
    event.preventDefault();
    document.querySelector('#temples').innerHTML = largeTempleCards.join('');
});

smallTempleButton.addEventListener('click', function (event) {
    event.preventDefault();
